...
def economy():
    charts = [
        ...
        Chart(title='Рост ВВП в долларах США',
              ...
              kind='bar',
              tooltip='Рост ВВП является важным общепринятым показателем роста экономики, т.к. показывает стала ли страна производить больше товаров или услуг в стоимостном выражении. Он также является индикатором эффективности государственной экономической программы'
              ),
