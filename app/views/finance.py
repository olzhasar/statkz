...
def finance():
    charts = [
        Chart(title='Государственный бюджет РК',
              ...
              kind='bar',
              tooltip='Государственный бюджет Республики Казахстан представляет собой общий бюджет страны и включает в себя Республиканский и Местный бюджеты. Доходы бюджета формируются за счет налоговых и неналоговых поступлений, поступлений от продажи основного капитала и трансфертов (из других бюджетов и нижестоящих органов). Расходы гос. бюджета также представляют собой консолидированные расходы республиканского и местного бюджетов. В Казахстане применяется принцип финансовой централизации. Это означает, что все поступления консолидируются в гос. бюджете, из которого в дальнейшем делаются распределения в республиканский и местный бюджеты согласно потребностям для реализации соответствующих программ',
              ),
